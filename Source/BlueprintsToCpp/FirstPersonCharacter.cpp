...
void AFirstPersonCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction(TEXT("Grab"), EInputEvent::IE_Pressed, this, &AFirstPersonCharacter::GrabPress);
	PlayerInputComponent->BindAction(TEXT("Grab"), EInputEvent::IE_Released, this, &AFirstPersonCharacter::GrabRelease);
}
...
void AFirstPersonCharacter::GrabPress()
{
	GetGrabber()->GrabPress();
}

void AFirstPersonCharacter::GrabRelease()
{
	GetGrabber()->GrabRelease();
}
